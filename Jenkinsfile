...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 891377033015.dkr.ecr.ap-south-1.amazonaws.com/dotnet-project
	 docker build -t 891377033015.dkr.ecr.ap-south-1.amazonaws.com/dotnet-project:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 891377033015.dkr.ecr.ap-south-1.amazonaws.com/dotnet-project:SAMPLE-PROJECT-${BUILD_NUMBER}
